...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Billing", href: "/finance/billing", icon: CreditCard, implemented: true },
      { title: "Wallet", href: "/finance/wallet", icon: Wallet, implemented: true },
      { title: "Invoices", href: "/finance/invoices", icon: Receipt, implemented: true },
      { title: "Subscriptions", href: "/finance/subscriptions", icon: Landmark, implemented: true },
    ],
  },
  {
    ...
    items: [
      ...
      { title: "User asset access", href: "/admin/user-asset-access", icon: Link2, implemented: true },
      { title: "System Health", href: "/admin/system-health", icon: HeartPulse, implemented: true },
      { title: "Roles", href: "/admin/roles", icon: ShieldCheck, implemented: true },
      ...
      { title: "API Keys", href: "/admin/api-keys", icon: KeyRound, implemented: true },
      { title: "Integrations", href: "/admin/integrations", icon: Link2, implemented: true },
      { title: "Settings", href: "/admin/settings", icon: Settings, implemented: true },
    ],
  },
];
